...
export default function ProjectsPage() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <p className="text-gray-500 text-sm mb-6">Browse active projects and task information.</p>
                    ...
                    {task.enrolledDevelopers && task.enrolledDevelopers.length > 0 && (
                      <div className="px-4 py-2 bg-gray-50 border-t border-gray-100">
                        <p className="text-xs font-bold text-gray-400 uppercase mb-1">
                          Assigned Developers ({task.enrolledDevelopers.length}/{task.max_developers})
                        </p>
